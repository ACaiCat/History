...
namespace History
{
    ...
    public class History : TerrariaPlugin
    {
        ...
        {
            get { return "Maintained by Cracker64 & Zaicon 创造 Cai翻新"; }
        }
        ...
        bool[] breakableBottom = new bool[693];
        bool[] breakableTop = new bool[693];
        bool[] breakableSides = new bool[693];
        bool[] breakableWall = new bool[693];
        void initBreaks()
        {
