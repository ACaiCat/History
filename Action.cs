	...
	public class Action
	{
			...
			switch (action)
			{
				...
				case 1://add tile
					...
					if (Main.tileFrameImportant[data])
						TSPlayer.All.SendTileSquareCentered(x, y, 8);
					else
						TSPlayer.All.SendTileSquareCentered(x, y, 1);
					break;
				case 2://del wall
		...
		public void Rollback()
		{
			switch (action)
			{
				...
				frameOnly:
					...
					if (Main.tileFrameImportant[data])
						if (data == 104)
							TSPlayer.All.SendTileSquareCentered(x, y - 2, 8);
						else
							TSPlayer.All.SendTileSquareCentered(x, y, 8);//This can be very large, or too small in some cases
					else
						TSPlayer.All.SendTileSquareCentered(x, y, 1);
					break;
				case 1://add tile
		...
		public override string ToString()
		{
			...
			switch (action)
			{
				...
				case 4:
                case 20:
					return string.Format("{0} {1} 破坏方块 {2}. ({3})", date, account, data, dhms);
				case 1:
					return string.Format("{0} {1} 放置方块 {2}. ({3})", date, account, data, dhms);
				case 2:
					return string.Format("{0} {1} 破坏墙 {2}. ({3})", date, account, data, dhms);
				case 3:
					return string.Format("{0} {1} 放置墙 {2}. ({3})", date, account, data, dhms);
				case 5:
				case 10:
				case 12:
				case 16:
					return string.Format("{0} {1} 放置电线. ({2})", date, account, dhms);
				case 6:
				case 11:
				case 13:
				case 17:
					return string.Format("{0} {1} 破坏电线. ({2})", date, account, dhms);
				case 7:
				case 14:
					return string.Format("{0} {1} 改变图格形状. ({2})", date, account, dhms);
				case 8:
					return string.Format("{0} {1} 放置致动器. ({2})", date, account, dhms);
                case 21:
                    return string.Format("{0} {1} 放置物块 ({2})", date, account, dhms);
                case 22:
                    return string.Format("{0} {1} 放置墙. ({2})", date, account, dhms);
                case 25:
				case 26:
					return string.Format("{0} {1} 涂漆物块/墙. ({2})", date, account, dhms);
				case 27:
					return string.Format("{0} {1} 修改了告示牌文字. ({2})", date, account, dhms);
				default:
					return "";
			}
		}
